...
composer install.
The app is prepared to work with Laravel
```
docker compose run --rm artisan scout:index cartographers
docker compose run --rm artisan migrate:fresh --seed
docker compose run --rm artisan scout:import "App\Models\Cartographer"
```
Usage
